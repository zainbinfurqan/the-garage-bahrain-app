...
export const CONSTANTS = {
    ...
    BORDER_COLOR_MEDIUM_GREY: '#C6C5C5',
    BORDER_COLOR_DARK_GREY: '#ABA9A9',
    BORDER_COLOR_RED_: '#ed2025',
    TEXT_COLOR_LIGHT_GREY: '#DEDEDE',
    TEXT_COLOR_MEDIUM_GREY: '#C6C5C5',
    TEXT_COLOR_DARK_GREY: '#ABA9A9',
    LIGHT_RED_COLOR: '',
    WHITE_COLOR: 'white',
    DARK_RED_COLOR: '#ed2025',
    LIGHT_YELLOW_COLOR: '',
    DARK_YELLOW_COLOR: '#ffd100',
    SMALL_FONT_SIZE: 10,
    SMALL_LEVEL1_FONT_SIZE: 12,
    MEDIUM_FONT_SIZE: 15,
    MEDIUM_LEVEL1_FONT_SIZE: 25,
    LARGE_FONT_SIZE: 25,
    ...
    COUNTRIES: [
        { key: 'India', value: 'India', shortKey: 'IND' },
        { key: 'Pakistan', value: 'Pakistan', shortKey: 'PAK' },
        { key: 'Australia', value: 'Australia', shortKey: 'AUS' },
    ],
    GENDER: [
